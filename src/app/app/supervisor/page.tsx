        ...
        <div className="glass fade-in" style={{ width: "100%", maxWidth: 420, padding: "32px 24px", textAlign: "center", borderRadius: 24, border: "1px solid rgba(255, 255, 255, 0.05)", background: "rgba(255, 255, 255, 0.01)" }}>
          ...
          <div className="glass" style={{ padding: 20, borderRadius: 18, border: "1px solid rgba(255,255,255,0.06)", background: "rgba(0,0,0,0.2)", marginBottom: 24, textAlign: "left" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
              ...
              {isShiftActive ? (
                <span style={{ display: "inline-flex", alignItems: "center", gap: 6, background: "rgba(34,197,94,0.15)", color: "#4ade80", border: "1px solid rgba(34,197,94,0.25)", borderRadius: 8, padding: "4px 10px", fontSize: 11, fontWeight: 800, textTransform: "uppercase" }}>
                  <span className="dot-pulse" style={{ background: "#22c55e", width: 6, height: 6 }} /> Active Deployment
                </span>
              ) : (
            ...
            {isShiftActive ? (
              <div>
                <p style={{ fontSize: 13, color: "#cbd5e1", lineHeight: 1.5, margin: 0 }}>
                  You are currently checked-in at <strong style={{ color: "#a78bfa" }}>{checkInTime}</strong> for on-site geological operations.
                </p>
                <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 14, background: "rgba(6,182,212,0.05)", border: "1px solid rgba(6,182,212,0.15)", borderRadius: 10, padding: "10px 12px" }}>
                  <div className="dot-pulse" style={{ background: "#06b6d4" }} />
                  <span style={{ fontSize: 11, color: "#06b6d4", fontWeight: 700 }}>Background Telemetry Loop Active</span>
                </div>
              </div>
            ) : (
              <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <button 
              ...
              style={{
                width: "100%",
                minHeight: 48,
                background: isShiftActive ? "rgba(239,68,68,0.1)" : "linear-gradient(135deg, #06b6d4 0%, #7c3aed 100%)",
                ...
                justifyContent: "center",
                gap: 8,
                boxShadow: isShiftActive ? "none" : "0 4px 15px rgba(6, 182, 212, 0.2)",
