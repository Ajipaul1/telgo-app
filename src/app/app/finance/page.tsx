                      ...
                      srcDoc={`
                        ...
                        <body>
                          ...
                          <script>
                            ...
                            L.polyline(path, { color: '#facc15', weight: 8, opacity: 0.25, lineJoin: 'round' }).addTo(map);
                            const mainLine = L.polyline(path, { color: '#facc15', weight: 3.5, opacity: 0.95, lineJoin: 'round' }).addTo(map);
