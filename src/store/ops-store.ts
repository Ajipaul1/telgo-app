  ...
  persist(
    (set, get) => ({
      ...
      addShiftReport: (report) => {
        ...
        set((state) => {
          const project = state.managedProjects.find((item) => item.id === report.projectId);
          return {
            ...
            projectReports: [
              {
                ...
                imageCount: report.photoName ? 1 : 0,
                submittedAt: nowText()
              },
            ...
            notifications: [
              {
                ...
                body: `${getUserName(state.users, report.userId)} submitted meterage, fuel and safety notes.`,
                type: "system",
                createdAt: nowText(),
                read: false
              },
