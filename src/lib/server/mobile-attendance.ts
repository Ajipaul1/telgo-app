...
import { distanceMeters, formatAttendanceRow, formatLocationRow } from "@/lib/mobile-attendance";
...
export type MarkMobileAttendanceInput = {
  latitude: number;
  longitude: number;
...
function buildFallbackTrackingSnapshot(canViewAll: boolean): any {
  return {
...
function dedupeLatestLocations(locations: any[], canViewAll: boolean) {
